...
//                ////
//                sendMessage(String.valueOf(sendingMsg.getText()), currentDate(), App.getModel().getUser().getName() , Utility.getUserIP()); //maybe after put it in server it display the messages on the screen for valid that the messages on the server
//                sendingMsg.setText("");
//
//            }
//        });
